...
Item {
    ...
    Camera {
        id: camera
        deviceId: Platform=="ANDROID" ?QtMultimedia.availableCameras[0].deviceId :QtMultimedia.availableCameras[1].deviceId
                    ...
                    source:{
                        ...
                        if(parent.tag_index>-1){
                            if(parent.tag_name.length==1)
                                name= "qrc:/tags_images/AR_MATRIX_CODE_4x4_BCH_13_9_3/00"+parent.tag_name+".png"
                            else if(parent.tag_name.length==2)
                                name= "qrc:/tags_images/AR_MATRIX_CODE_4x4_BCH_13_9_3/0"+parent.tag_name+".png"
                            else
                                name= "qrc:/tags_images/AR_MATRIX_CODE_4x4_BCH_13_9_3/"+parent.tag_name+".png"
                        }
                        return name;
                    }
