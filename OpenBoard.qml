    ...
    Item{
        ...
        Repeater{
            ...
            Image{
                ...
                function update_from_image(){
                    ...
                    if(index>-1){
                        ...
                        if(tag_name.length==1)
                            tag_name="qrc:/tags_images/AR_MATRIX_CODE_4x4_BCH_13_9_3/00"+tag_name+".png"
                        else if(tag_name.length==2)
                            tag_name="qrc:/tags_images/AR_MATRIX_CODE_4x4_BCH_13_9_3/0"+tag_name+".png"
                        else
                            tag_name="qrc:/tags_images/AR_MATRIX_CODE_4x4_BCH_13_9_3/"+tag_name+".png"
                        tag_index=index;
                ...
                Image{
                    source:parent.tag_index!=-1 ? parent.tag_name :""
                    width: tag_size_px
